          ...
          <div class="container">
            ...
            @csrf
                    <div class="form-group">
                    	<h1><center>Crear nuevo Producto</center></h1>
                      <input type="text" class="form-control form-control-user" name="name" value="{{ old('name') }}" aria-describedby="emailHelp" placeholder="Nombre...">
                      {!! $errors->first('name','<small style="color: red;">:message</small>') !!}
                    </div>
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" name="description" value="{{ old('description') }}" placeholder="Descripcion...">
